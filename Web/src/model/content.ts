export default class Content {
    static headerDescription = 'Navigation links pertaining to the various sections of the page.';
    static heroDescription = 'Presentational hero section';
    static heroTitle = 'Welcome to my demo project';
    static heroBody = '';
